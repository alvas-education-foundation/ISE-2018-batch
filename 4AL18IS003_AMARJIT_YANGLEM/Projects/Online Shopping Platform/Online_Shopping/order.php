...
<div id="CentralPart">
<div><br/><center><h2><font face="lucida sans unicode" size="+2" color="#00CCFF">Welcome 
<?php
...
<center><h2><font face="lucida sans unicode" size="+1" color="#00CCFF">Order Form</font></h2></center>
...
<table width="366" border="0" align="center">
  ...
  <tr>
    <td><div align="center"><strong><font size="+1" face="lucida sans unicode">Product Name: </font></strong></div></td>
    <td><label>
  ...
  <tr>
    <td width="164"><div align="center"><font size="+1" face="lucida sans unicode"><b> Item No:</b></font></div></td>
    <td width="192">
      
        <input name="m2" type="text" id="m2" onChange="return fnam()" readonly="readonly" value="<?php echo $mat['itemno'];?>">    </td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><strong>Price:</strong></font></div></td>
    <td><input name="m3" type="text" id="m3" onChange="return lnam()" readonly="readonly" value="Rs<?php echo $mat['price'];?>">  </td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><b>&nbsp;Size:</b> </font></div></td>
    <td><label>
  ...
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><b>&nbsp;User Name  : </b></font></div></td>
    <td><input name="t1" type="text" id="t1" onChange="return email()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><b>&nbsp;Account No: </b> </font></div></td>
    <td><input name="t2" type="text" id="t2" onChange="return pass()"></td>
  </tr>
  <tr> <td><div align="center"><font size="+1" face="lucida sans unicode"><b>Mobile no: </b></font></div></td>
    <td><input name="t3" type="text" id="t3" onChange="return phone()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><strong>Address:</strong></font></div></td>
    <td><label>
      <textarea name="t4" id="t4" value="return add()"></textarea>
    </label></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><strong>Bank:</strong></font></div></td>
    <td><label>
  ...
  <tr>
    <td><div align="center"><font size="+1" face="lucida sans unicode"><strong>City:</strong></font></div></td>
...
<div id="Bottom">
<p class="down"><b>Copyright &copy; Online Shopping, Design by:Ranjan & Amarjit</b></p>
</div>
</div>
</div>
</div>
